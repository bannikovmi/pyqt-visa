...
class sweep_Ui_Form(object):
	def setupUi(self, Dialog):
		...
		self.increment.setMinimum(0)
		self.increment.setMaximum(100000)
		self.vTarget = QtWidgets.QDoubleSpinBox(Dialog)
		self.vTarget.setObjectName('vTarget')
		self.vTarget.setValue(0)
		self.vTarget.setMinimum(-100000)
		self.vTarget.setMaximum(100000)
		...
		self.vCurrent = QtWidgets.QDoubleSpinBox(Dialog)
		self.vCurrent.setObjectName('vCurrent')
		self.vCurrent.setValue(0)
		self.vCurrent.setMinimum(-100000)
		self.vCurrent.setMaximum(100000)
		...
		self.vlayout.addWidget(self.vTarget)
    ...
    # ~ QLabel *label6=new QLabel(tr("Write Command:"), this);
		self.label1.setText(_translate("Target value:", "Target value:"))
...
class sweepDialog(QtWidgets.QDialog, sweep_Ui_Form):
	...
	def __init__(self, rm):
		...
		self.devList.currentTextChanged.connect(self.onChange)
